...
- [x] **Step 1: Validate the register**
...
- [x] **Step 2: Confirm the user drafts remain excluded**
...
- [x] **Step 3: Commit only the governance files**
...
- [x] **Step 1: Record the pre-change validation result**
...
- [x] **Step 3: Reconcile the lexicon**
...
- [x] **Step 4: Add canonical public strings**
...
- [x] **Step 5: Approve launch-critical register rows**
...
- [x] **Step 1: Capture the current navigation assertion**
...
- [x] **Step 3: Implement the grouped navigation**
...
- [x] **Step 5: Update shared styling**
...
- [x] **Step 1: Verify the routes do not yet exist**
...
- [x] **Step 2: Create the Intelligences hub**
...
- [x] **Step 3: Create or revise the seven domain pages**
...
- [x] **Step 4: Create the Experience Journeys hub**
...
- [x] **Step 5: Build and lint the new routes**
...
- [x] **Step 1: Record the current terminology**
...
- [x] **Step 2: Create the canonical Consumer Outcomes page**
...
- [x] **Step 4: Reframe advisory and operating model**
...
- [x] **Step 5: Update governance references**
...
- [x] **Step 6: Build and verify redirects**
...
- [x] **Step 1: Create the Architecture Library**
...
- [x] **Step 2: Create Prototype Specifications**
...
- [x] **Step 3: Create the Ultim8 page with a stability hold**
...
- [x] **Step 4: Align architecture source documents**
...
- [x] **Step 1: Update Insights discovery**
...
- [x] **Step 2: Align contact and About**
...
- [x] **Step 3: Review policy content separately**
...
- [x] **Step 4: Preserve historical content**
...
- [x] **Step 1: Verify that Phase 9 planning and design are locked**
...
- [x] **Step 2: Compare the site with the locked design**
...
- [x] **Step 3: Preserve the launch claim boundary**
...
- [x] **Step 4: Update status and conflicts**
...
- [x] **Step 5: Build and run boundaries**
...
- [x] **Step 1: Run the full build and existing checks**
...
- [x] **Step 2: Check links, routes, and redirects**
...
- [x] **Step 3: Run one six-perspective editorial pass**
