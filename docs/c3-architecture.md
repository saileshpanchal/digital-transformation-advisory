...
> **Reconciled with master (2026-06-15).** The site, the DBB paper,
> `docs/lexicon.md`, `docs/claim-register.md` and `docs/squad-operating-model.md`
> standardise on **C3 = Capability · Context · Consent**. This doc follows that
> order. C3 is the *architecture*; **Owned Autonomy** (accountable + sovereign) is
> the *principle* it delivers. The demonstration platform is **The Accountable
...
> sits beneath the Eight Intelligences, not a competing top-level hierarchy. It
...
- **Owned Autonomy** is the principle (accountable + sovereign); **C3** is the
  architecture that delivers it; **The Accountable Bank** (the Clean-Room
  Demonstration) shows it running.
