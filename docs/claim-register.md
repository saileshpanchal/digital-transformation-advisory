...
| Customer Outcomes page — repositioned as a **pre-delivery proving ground**; differentiator = testing the **agentic** impact on consumer outcomes (agent runs under C3 controls + evidence). "Customer Outcomes Design Lab" / proving-ground = **proposed extension of the prototype (BLUEPRINT)**, configured per engagement; NOT a shipped service. Substantiated parts: Family Wealth demo, agent-propose/human-approve, recorded evidence (synthetic). FCA Consumer Duty = external/attribute. | FCA (external) + Family Wealth demo (substantiated) + prototype roadmap (blueprint) | DTA | Approved — Lab labelled blueprint; agentic-controls claims anchored on FW demo; **no compliance certification** | 2026-09-18 | customer-outcomes; `docs/demo-script-customer-outcomes-lab.md` | External + DTA framing + blueprint |
