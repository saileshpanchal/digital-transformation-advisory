...
- **The platform diagnoses by walking its own graph.** Because the dependency map stays current, the platform can trace from a failing component up to the services that sit on it, and down to the work that was in flight.
